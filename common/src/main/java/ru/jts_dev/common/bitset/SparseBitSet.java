package ru.jts_dev.common.bitset;
...
public class SparseBitSet implements Cloneable, Serializable {
     ...
     * @throws IndexOutOfBoundsException if <code>i</code> is negative or
     ...
     * @throws IndexOutOfBoundsException if <code>i</code> is negative or is
